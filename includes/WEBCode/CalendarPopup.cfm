...
function CalendarPopup_getCalendar() {
	...
	if (this.displayType=="date" || this.displayType=="week-end") {
		...
		var date_class;
		if (this.type!="WINDOW") {
			result += '<TABLE WIDTH=155 BORDER=5 bordercolor=#000066 BORDERWIDTH=0 CELLSPACING=0 CELLPADDING=1>\n';
			}
		result += '<TR BGCOLOR="#000066">\n';
		...
		if (this.isShowYearNavigation) {
			...
			result += '	<TD STYLE="color:#F8F400; font:10; background-color: #1F1FC3" WIDTH=22 ALIGN=CENTER VALIGN=MIDDLE><B><A STYLE="color:#F8F400; font:10; background-color: #1F1FC3" HREF="'+refresh+'('+this.index+','+last_month+','+last_month_year+');">&lt;&lt;</A></B></TD>\n';
			result += '	<TD STYLE="color:#F8F400; font:10; background-color: #1F1FC3" WIDTH=100 ALIGN=CENTER>'+this.monthNames[month-1]+' '+year+'</TD>\n';
			result += '	<TD STYLE="color:#F8F400; font:10; background-color: #1F1FC3" WIDTH=22 ALIGN=CENTER VALIGN=MIDDLE><B><A STYLE="color:#F8F400; font:10; background-color: #1F1FC3" HREF="'+refresh+'('+this.index+','+next_month+','+next_month_year+');">&gt;&gt;</A></B></TD>\n';
			}
		result += '</TR></TABLE>\n';
		result += '<TABLE WIDTH=120 BORDER=0 CELLSPACING=1 CELLPADDING=2 ALIGN=CENTER>\n';
		result += '<TR>\n';
