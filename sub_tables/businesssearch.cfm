...
<HEAD>
<cfoutput>
<title>#strLBLSearchSelect#</title>
</cfoutput>
...
<table align="left" width="100%" border="1" cellspacing="0" cellspadding="0">
	<tr bgcolor="#408080">
		<cfoutput>
		<td width="90%" style="font:10; color:F8CC30;">#strLBLContact#</td>
		<td width="10%"  style="font:10; color:F8CC30;">Action</td>
		</cfoutput>
	</tr>
	<cfstoredproc procedure="pkg_select.ap_select_vet"  datasource="#application.avdrdsn#" username="#session.userid#" password="#session.password#">
	<cfprocparam type="in" dbvarname="name" value="#name#" cfsqltype="cf_sql_varchar">
	<cfprocparam type="in" dbvarname="bptype" value="#type#" cfsqltype="cf_sql_varchar">
	...
	<cfoutput query="rs">
		...
		<tr align="right"  valign="top" bgcolor=#txtColor#>
			<td width="90%" align="left" style="font:10px">#rs.name#</td>
			...
			<input type="hidden" name="desc#row#" value="#rs.party_id#"></td>
		</tr>
	</cfoutput>
</table>
<cfif row is 1>
