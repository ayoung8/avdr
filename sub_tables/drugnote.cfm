...
<cfif Operation is "add">
  <cfstoredproc procedure="pkg_drug.ap_add_drug_notes"  datasource="#application.avdrdsn#" username="#session.userid#" password="#session.password#">
...
<cfElseIf Operation is "update">
  <cfstoredproc procedure="pkg_drug.ap_update_drug_notes"  datasource="#application.avdrdsn#" username="#session.userid#" password="#session.password#">
  <cfprocparam type="in" dbvarname="drugid" value="#DrugID#" cfsqltype="cf_sql_integer">
...
<cfelseif Operation is "Delete">
  <cfstoredproc procedure="pkg_drug.ap_delete_drug_notes"  datasource="#application.avdrdsn#" username="#session.userid#" password="#session.password#">
  <cfprocparam type="in" dbvarname="drugid" value="#DrugID#" cfsqltype="cf_sql_integer">
  <cfprocparam type="in" dbvarname="notesid" value="#notes_id#" cfsqltype="cf_sql_integer">
  </cfstoredproc>
</cfif>
...
<form action="drugnote.cfm" name="detail" id="detail" method="post" target="">
			...
			<tr align="right"  valign="top" bgcolor=#txtColor# onMouseOver="this.bgColor='##408080'; document.all.delimg#row#.src='../images/delhl.bmp'; document.all.editimg#row#.src='../images/edithl.bmp';" onMouseOut="this.bgColor='#txtColor#'; document.all.delimg#row#.src='../images/del.bmp'; document.all.editimg#row#.src='../images/edit.bmp';">
				...
				<td width="8%" align="center" style="font:13px">
				    <cfif session.drug_role gt 1>
	      			...
	      			<A HREF="##" STYLE="color:navy;" onclick="var dodelete=window.confirm('#strAlertDeleteMe#'); if(dodelete) window.location='#SCRIPT_NAME#?Operation=Delete&drug_id=#DrugID#&notes_id=#rs.notes_id#';"><img src="../Images/del.bmp" name="delimg#row#" border="0"></A>
					</cfif>
				</td>
...
<script language=javascript>
  parent.window.frmdrug.notes_description.value = '';
  ...
  function SendToParent(notes_id,notes_type_id,notes_severity_type_id,notes_description) 
  {
	...
	parent.window.frmdrug.notes_type_id.value = notes_type_id;
	parent.window.frmdrug.notes_severity_type_id.value = notes_severity_type_id;
	parent.window.frmdrug.notes_description.value = notes_description;
  }
</script>
</body>
</html>